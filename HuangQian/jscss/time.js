function showTime() { 
	...
	var startDate = new Date(2015, 05, 01);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Memorialization:<br>"
		+ "We have know for:<br> "
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----Scoefield  2018-02-03&nbsp</c>"; 
