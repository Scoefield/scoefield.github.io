function showTime() { 
	...
	var startDate = new Date(2018, 06, 18);
	...
	var currentTimeString = "<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----Scoefield  2018-07-19&nbsp</c>"; 
